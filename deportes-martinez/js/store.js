...
import { setProductos, initCart, enCarrito } from "./cart.js?v=32";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=32";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=32";
import { track } from "./track.js?v=32";
