...
import { setProductos, initCart, enCarrito } from "./cart.js?v=39";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=39";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=39";
import { track } from "./track.js?v=39";
