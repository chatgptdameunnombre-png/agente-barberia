...
import { setProductos, initCart, enCarrito } from "./cart.js?v=38";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=38";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=38";
import { track } from "./track.js?v=38";
