...
import { setProductos, initCart, enCarrito } from "./cart.js?v=43";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=43";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=43";
