...
import { setProductos, initCart, enCarrito } from "./cart.js?v=60";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=60";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=60";
import { track } from "./track.js?v=60";
