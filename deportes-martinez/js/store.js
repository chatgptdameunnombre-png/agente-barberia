...
import { setProductos, initCart, enCarrito } from "./cart.js?v=44";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=44";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=44";
