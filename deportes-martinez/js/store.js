...
import { setProductos, initCart, enCarrito } from "./cart.js?v=59";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=59";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=59";
import { track } from "./track.js?v=59";
