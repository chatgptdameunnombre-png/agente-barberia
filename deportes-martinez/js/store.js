...
import { setProductos, initCart, enCarrito } from "./cart.js?v=61";
import { tieneTallas, stockTotal, precioDesde, preciosVarian, etiquetaStock, tallasDisponibles } from "./tallas.js?v=61";
import { onMayoreo, precioHTML } from "./mayoreo.js?v=61";
import { track } from "./track.js?v=61";
