import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=51";
import { track } from "./track.js?v=51";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=51";
...
import("./db.js?v=51").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
