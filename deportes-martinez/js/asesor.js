import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=52";
import { track } from "./track.js?v=52";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=52";
...
import("./db.js?v=52").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
