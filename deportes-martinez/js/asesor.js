import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=30";
import { track } from "./track.js?v=30";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=30";
...
import("./db.js?v=30").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
