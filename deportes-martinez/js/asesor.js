import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=69";
import { track } from "./track.js?v=69";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=69";
...
import("./db.js?v=69").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
