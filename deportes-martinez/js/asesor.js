import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=61";
import { track } from "./track.js?v=61";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=61";
...
import("./db.js?v=61").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
