import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=60";
import { track } from "./track.js?v=60";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=60";
...
import("./db.js?v=60").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
