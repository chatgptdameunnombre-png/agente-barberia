import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=37";
import { track } from "./track.js?v=37";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=37";
...
import("./db.js?v=37").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
