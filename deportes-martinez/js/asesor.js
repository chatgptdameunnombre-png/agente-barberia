import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=38";
import { track } from "./track.js?v=38";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=38";
...
import("./db.js?v=38").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
