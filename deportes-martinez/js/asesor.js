import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=46";
import { track } from "./track.js?v=46";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=46";
...
import("./db.js?v=46").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
