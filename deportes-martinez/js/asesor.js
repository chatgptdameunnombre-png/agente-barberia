import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=64";
import { track } from "./track.js?v=64";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=64";
...
import("./db.js?v=64").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
