import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=43";
import { track } from "./track.js?v=43";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=43";
...
import("./db.js?v=43").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
