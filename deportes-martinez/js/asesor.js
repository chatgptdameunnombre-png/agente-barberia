import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=33";
import { track } from "./track.js?v=33";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=33";
...
import("./db.js?v=33").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
