import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=50";
import { track } from "./track.js?v=50";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=50";
...
import("./db.js?v=50").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
