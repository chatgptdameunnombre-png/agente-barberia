import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=36";
import { track } from "./track.js?v=36";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=36";
...
import("./db.js?v=36").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
