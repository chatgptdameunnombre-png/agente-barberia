import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=34";
import { track } from "./track.js?v=34";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=34";
...
import("./db.js?v=34").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
