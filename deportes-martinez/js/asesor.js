import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=42";
import { track } from "./track.js?v=42";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=42";
...
import("./db.js?v=42").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
