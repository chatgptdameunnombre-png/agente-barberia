import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=77";
import { track } from "./track.js?v=77";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=77";
import { conectarFormulario, tarjetaSugerenciaHTML } from "./sugerencias.js?v=77";
...
import("./db.js?v=77").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
