import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=80";
import { track } from "./track.js?v=80";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=80";
import { conectarFormulario, tarjetaSugerenciaHTML } from "./sugerencias.js?v=80";
...
import("./db.js?v=80").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
