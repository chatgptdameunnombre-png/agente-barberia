import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=70";
import { track } from "./track.js?v=70";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=70";
...
import("./db.js?v=70").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
