import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=57";
import { track } from "./track.js?v=57";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=57";
...
import("./db.js?v=57").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
