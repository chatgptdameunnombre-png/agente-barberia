import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=39";
import { track } from "./track.js?v=39";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=39";
...
import("./db.js?v=39").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
