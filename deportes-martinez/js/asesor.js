import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=47";
import { track } from "./track.js?v=47";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=47";
...
import("./db.js?v=47").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
