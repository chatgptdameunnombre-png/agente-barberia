import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=67";
import { track } from "./track.js?v=67";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=67";
...
import("./db.js?v=67").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
