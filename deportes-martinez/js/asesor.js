import { ASESOR_WEBHOOK, NEGOCIO, firebaseConfig } from "./config.js?v=35";
import { track } from "./track.js?v=35";
import { tieneTallas, stockTotal, precioDesde, preciosVarian } from "./tallas.js?v=35";
...
import("./db.js?v=35").then(m => { m.db.onProducts(list => setProductos(list)); }).catch(() => {});
