...
function mostrar() {
  ...
  b.id = "ckBanner";
  b.style.cssText = "position:fixed;left:16px;right:16px;bottom:16px;z-index:9998;background:#121826;border:1px solid #26304a;border-radius:16px;padding:16px 18px;display:flex;gap:14px;align-items:center;flex-wrap:wrap;box-shadow:0 20px 50px rgba(0,0,0,.5);max-width:720px;margin:0 auto";
  b.innerHTML = `
    ...
    <div style="display:flex;gap:8px">
      <button id="ckNo" style="background:none;border:1px solid #2a3244;color:#c0c0c4;border-radius:10px;padding:10px 14px;font-size:13.5px;cursor:pointer">Solo lo necesario</button>
