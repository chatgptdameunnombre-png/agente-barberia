...
import { NIVEL_PRUEBA, construir, CELDA } from './mapa.js?v=20260908175914';
import { Jugador } from './jugador.js?v=20260908175914';
import { Enemigo, TIPOS } from './enemigos.js?v=20260908175914';
import { cortarTira, cortarRejilla, cargarImagen, recorteEntero, recorteSuperior, recorteInferior, Billboard } from './sprites.js?v=20260908175914';
import { Objeto, CATALOGO } from './objetos.js?v=20260908175914';
import { Rondas } from './rondas.js?v=20260908175914';
import { Tienda, porId, MEJORAS, CONSUMIBLES } from './tienda.js?v=20260908175914';
import { RELIQUIAS, porReliquia } from './reliquias.js?v=20260908175914';
import { TINTES, COLORES, MIRAS, leer, guardar, aplicar } from './apariencia.js?v=20260908175914';
import { MODOS, MEJORAS_MERCADER, OBJETOS as OBJETOS_GLORIA, ESTILOS, LIMITE_OBJETOS, TODO as TODO_GLORIA, TODO_GRATIS, estado as estadoGloria, guardar as guardarGloria, activo as modoActivo, tiene as tieneGloria } from './gloria.js?v=20260908175914';
import { Minimapa, Marcas } from './minimapa.js?v=20260908175914';
import { Flujo } from './flujo.js?v=20260908175914';
import { Portales, trazar } from './portales.js?v=20260908175914';
import { romper } from './mapa.js?v=20260908175914';
import { Audio } from './audio.js?v=20260908175914';
import { OtroLado } from './otrolado.js?v=20260908175914';
import { Grieta } from './grieta.js?v=20260908175914';
import { Director } from './director.js?v=20260908175914';
import { Cerco } from './cerco.js?v=20260908175914';
import { esTactil, esTelefono, Tactil } from './tactil.js?v=20260908175914';
import { TIPOS as T } from './enemigos.js?v=20260908175914';
import { siluetaCiclope } from './texturas.js?v=20260908175914';
import { Misiones, ARCOS } from './misiones.js?v=20260908175914';
...
if (('ontouchstart' in window) || navigator.maxTouchPoints > 0) {
  ...
  if (p) p.textContent = 'TOCA PARA EMPEZAR';
}

const recursos = { arco: [], items: [], tienda: [], cuerno: [], guante: [], reliquias: [], hilo: [], jabalina: [], hacha: [], tajo: [], vuelo: [], kTajo: [], cuchillo: [], pico: [], mano: [], fuego: [], insignias: [], mercader: null, ciclope: null, pretendiente: null };
...
const ARCOS_HOJA = [
  ['arcoFontanero', './arte/crudo/arco-fontanero.webp?v=20260908175914'],
  ['arcoSierra', './arte/crudo/arco-sierra.webp?v=20260908175914'],
  ['arcoPortal', './arte/crudo/arco-portal.webp?v=20260908175914'],
  ['arcoFantasma', './arte/crudo/arco-fantasma.webp?v=20260908175914'],
  ['arcoSable', './arte/crudo/arco-sable.webp?v=20260908175914'],
  ['arcoAbismo', './arte/crudo/arco-abismo.webp?v=20260908175914']
];

const CARAS_HOJA = [
  ['carasFontanero', './arte/crudo/caras-fontanero.webp?v=20260908175914'],
  ['carasSierra', './arte/crudo/caras-sierra.webp?v=20260908175914'],
  ['carasPortal', './arte/crudo/caras-portal.webp?v=20260908175914'],
  ['carasFantasma', './arte/crudo/caras-fantasma.webp?v=20260908175914'],
  ['carasSable', './arte/crudo/caras-sable.webp?v=20260908175914'],
  ['carasAbismo', './arte/crudo/caras-abismo.webp?v=20260908175914']
];
...
function cargarArcos() {
  ...
  for (const [clave, ruta] of CARAS_HOJA) {
    cargarImagen(ruta).then(img => {
      if (!img) return;
      recursos[clave] = cortarTira(img, 5, { ajustar: true, altoComun: true })
        .map(t => t.image.toDataURL());
    });
  }
}
...
async function cargarArte() {
  const [idle, atk, die, bow, muros, cosas, mercancia, pIdle, pAtk, pDie, horn, viejo, rostros, mano, reliquias, cordel, asta, hachaImg, picoImg, manoImg, fuegoImg, medallas, cuchilloImg, tajoImg, vueloImg, kTajoImg, cicRayo, cicLanza, cicCuchillo, cicFuego, cicHacha, cicBomba, fichasImg,
    ...
    cargarImagen('./arte/crudo/ciclope.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-ataca.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-muere.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/arco.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/texturas.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/items.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/tienda.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/pretendiente.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/pretendiente-ataca.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/pretendiente-muere.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/cuerno.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/mercader.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/caras.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/guante.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/objetos2.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/hilo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/jabalina.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/hacha.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/pico.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/mano.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/fuego.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/insignias.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/cuchillo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/hacha-tajo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/hacha-vuelo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/cuchillo-tajo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-rayo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-lanza.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-cuchillo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-fuego.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-hacha.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/ciclope-bomba.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/fichas.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/polifemo.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/polifemo-ataca.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/polifemo-muere.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/bomba.webp?v=20260908175914'),
    cargarImagen('./arte/crudo/bomba-pegada.webp?v=20260908175914')
  ]);
  ...
  if (cicRayo) recursos.ciclope.muereRayo = cortarTira(cicRayo, 4);
  if (cicLanza) recursos.ciclope.muereLanza = cortarTira(cicLanza, 4);
  if (cicCuchillo) recursos.ciclope.muereCuchillo = cortarTira(cicCuchillo, 4);
  if (cicFuego) recursos.ciclope.muereFuego = cortarTira(cicFuego, 4);
  ...
  if (kTajoImg) {
    recursos.kTajo = cortarTira(kTajoImg, 4, { ajustar: true, altoComun: true });
    imagenesKTajo = recursos.kTajo.map(t => t.image.toDataURL());
  }
  if (vueloImg) {
  ...
  if (!kTajoImg) partes.push('cuchillo-tajo.png');
...
function limpiarCadaveres() {
  ...
  for (let i = enemigos.length - 1; i >= 0; i--) {
    ...
    escena.remove(enemigos[i].malla);
    enemigos.splice(i, 1);
    n++;
  }
  return n;
...
function nacer(pos, cfg, indice) {
  ...
  const e = new Enemigo(acomodar(pos), recursos[tipo.arte] || recursos.ciclope, nivel, { ...ajustado, tipo, flujo, portales, buscarPresa: presaCercana });
  if (otroLado.dentro) {
...
function centroLibre() {
  const cx = Math.floor(nivel.ancho / 2);
  const cz = Math.floor(nivel.alto / 2);
  let mejor = null, mejorD = Infinity;
  for (let z = 1; z < nivel.alto - 1; z++) {
    for (let x = 1; x < nivel.ancho - 1; x++) {
      if (!'.@E+'.includes(nivel.rejilla[z][x])) continue;
      const d = Math.hypot(x - cx, z - cz);
      if (d < mejorD) { mejorD = d; mejor = { x, z }; }
    }
  }
  const c = mejor || { x: cx, z: cz };
  return new THREE.Vector3(c.x * CELDA + CELDA / 2, 0, c.z * CELDA + CELDA / 2);
}
...
function soltarUno(celda, pos) {
  if (!recursos.items.length) return;
  const tipo = CATALOGO[celda];
  if (jugador.sinArco && tipo && tipo.efecto === 'flechas') return;
  const p = pos.clone(); p.y = 0;
  const o = new Objeto(tipo, recursos.items[tipo.celda], p);
  escena.add(o.malla);
  objetos.push(o);
}
...
function soltarObjetos(ronda) {
  ...
  const menu = [6, 7, 0, 2, 3, 4, 5, 8, 9, 9];
  const cuantos = Math.min(6, 3 + Math.floor(ronda / 3));
  const surtido = jugador.sinArco
    ? menu.filter(c => CATALOGO[c] && CATALOGO[c].efecto !== 'flechas')
    : menu;
  for (let i = 0; i < cuantos; i++) {
    const tipo = CATALOGO[surtido[Math.floor(Math.random() * surtido.length)]];
...
function presaCercana(yo) {
  let mejor = null, mejorD = Infinity;
  for (const o of enemigos) {
    if (o === yo || !o.vivo || o === yo.presa) continue;
    const d = Math.hypot(o.pos.x - yo.pos.x, o.pos.z - yo.pos.z);
    if (d < mejorD) { mejorD = d; mejor = o; }
  }
  if (mejor) return mejor;
  for (const o of enemigos) if (o !== yo && o.vivo) return o;
  return null;
}

const ARCO_PRUEBA = new URLSearchParams(location.search).get('arco');

function carasDelArco() {
  const id = ARCO_PRUEBA || (misiones && misiones.arcoPuesto);
  if (id) {
    const a = ARCOS.find(x => x.id === id);
    if (a) {
      const clave = 'caras' + a.hoja.slice(4);
      if (recursos[clave] && recursos[clave].length === 5) return recursos[clave];
    }
  }
  return imagenesCara;
}
...
function escalaArco() {
  if (jugador && jugador.sinArco) return 1;
  const id = ARCO_PRUEBA || (misiones && misiones.arcoPuesto);
  if (!id) return 1;
  const a = ARCOS.find(x => x.id === id);
  return a && a.escala && recursos[a.hoja] ? a.escala : 1;
}

function arcoPuesto() {
  if (ARCO_PRUEBA) {
    const p = ARCOS.find(x => x.id === ARCO_PRUEBA);
    if (p && recursos[p.hoja]) return p.hoja;
  }
...
let tempLetrero = 0;
function abrirGrieta(modo) {
  if (!grieta) return;
  otroLado.ofrecida = modo === 'entrar';
  grieta.abrir(modo, jugador);
  clearTimeout(tempLetrero);
  tempLetrero = setTimeout(() => { if (grieta.abierta) verGrieta(true, modo); }, 2700);
  audio.sonar('portalAzul');
...
function cruzarGrieta() {
  const modo = grieta.modo;
  clearTimeout(tempLetrero);
  grieta.cerrar();
  verGrieta(false);
  audio.sonar('cruzar');
  ...
  if (modo === 'entrar') {
    otroLado.entrar();
    dentroDesde = rondas.numero;
    destello('#c0304a', 0.7, 500);
    anunciar('EL OTRO LADO', 'TRIPLE ORO — NO HAY SALIDA EN 3 RONDAS');
  } else {
    otroLado.salir();
    dentroDesde = null;
    destello('#7fd4ff', 0.6, 450);
    anunciar('VOLVISTE A ITACA', 'EL MUNDO SE ACOMODA');
  }
}
...
const bombas = [];
const geoBomba = new THREE.SphereGeometry(0.55, 10, 8);
const matBomba = new THREE.MeshLambertMaterial({ color: 0x6b4a2a, emissive: 0x220a00 });
...
function lanzarBomba() {
  ...
  bombas.push({
    ...
    mecha: 2,
    pegada: null,
    desfase: new THREE.Vector3(),
    quieta: false
  });
  audio.sonar('lanza');
}

function estallarBomba(b) {
  const p = b.malla.position.clone();
  let tocados = 0;
  for (const e of enemigos) {
    if (!e.vivo) continue;
    const d = Math.hypot(e.pos.x - p.x, e.pos.z - p.z);
    if (e === b.pegada) {
      if (e.recibir(200 * jugador.mult.dano * furia(), 'bomba')) marcarBaja();
      tocados++;
    } else if (d < 8) {
      if (e.recibir(90 * jugador.mult.dano * furia(), 'bomba')) marcarBaja();
      tocados++;
    }
  }
  const dJugador = Math.hypot(jugador.pos.x - p.x, jugador.pos.z - p.z);
  if (dJugador < 8) jugador.recibir(45);
  audio.sonar('muerte', p);
  destello('#ff8a1f', 0.6, 260);
  sacudida = Math.max(sacudida, 1.2);
  avisar(tocados ? 'ESTALLA: ' + tocados : 'ESTALLA EN VANO');
  escena.remove(b.malla);
}

function moverBombas(dt) {
  for (let i = bombas.length - 1; i >= 0; i--) {
    ...
    if (b.pegada) {
      ...
      else b.malla.position.copy(b.pegada.pos).add(b.desfase);
    } else if (b.quieta) {
      for (const e of enemigos) {
        if (!e.vivo) continue;
        if (Math.hypot(e.pos.x - b.malla.position.x, e.pos.z - b.malla.position.z) < 2.4) {
          b.pegada = e;
          b.desfase.set(0, Math.min(3.4, e.sprite.alto * 0.55), 0);
          audio.sonar('carne', e.pos);
          avisar('PEGADA');
          break;
        }
      ...
      b.vel.y -= 20 * dt;
      const previa = b.malla.position.clone();
      b.malla.position.addScaledVector(b.vel, dt);
      if (portales) portales.atravesar(previa, b.malla.position, b.vel);
      for (const e of enemigos) {
        if (!e.vivo) continue;
        const d = Math.hypot(e.pos.x - b.malla.position.x, e.pos.z - b.malla.position.z);
        if (d < 2.4 && b.malla.position.y < e.sprite.alto) {
          b.pegada = e;
          b.desfase.set(0, Math.min(3.4, e.sprite.alto * 0.55), 0);
          audio.sonar('carne', e.pos);
          avisar('PEGADA');
      ...
      if (!b.pegada && b.malla.position.y < 0.5) {
        b.malla.position.y = 0.5;
        b.quieta = true;
      }
      const cx = Math.floor(b.malla.position.x / CELDA);
      const cz = Math.floor(b.malla.position.z / CELDA);
      const fila = nivel.rejilla[cz];
      if (!fila || '#CTRF'.includes(fila[cx] || '#')) {
        b.malla.position.copy(previa);
...
function lanzarFlecha(fuerza, dir, extra = 0, potencia = 1, marca = null) {
...
function lanzarRayo(carga) {
  ...
  for (const e of enemigos) {
    ...
    audio.sonar('carne', e.pos);
    if (e.recibir(dano, 'rayo')) marcarBaja();
  }
}
    ...
    if (!fuera) {
      for (const en of enemigos) {
        ...
        if (Math.hypot(en.pos.x - e.malla.position.x, en.pos.z - e.malla.position.z) < 3.2) {
          ...
          if (en.recibir(120 * jugador.mult.dano * furia(), 'piedra')) marcarBaja();
          fuera = true;
          break;
        }
      }
...
function moverHacha(dt) {
  ...
  for (const e of enemigos) {
    ...
    if (Math.hypot(e.pos.x - h.malla.position.x, e.pos.z - h.malla.position.z) < 3) {
      h.tocados.add(e);
      audio.sonar('carne', e.pos);
      if (e.recibir(95 * jugador.mult.dano * furia(), 'hacha')) marcarBaja();
    }
  }
}
...
function tajo() {
  ...
  for (const e of enemigos) {
    ...
    audio.sonar('carne', e.pos);
    const golpe = jugador.mano === 'cuchillo' ? (jugador.sinArco ? 50 : 140) : DANO_TAJO;
    if (e.recibir(golpe * jugador.mult.dano * furia(), jugador.mano === 'hacha' ? 'hacha' : 'cuchillo')) marcarBaja();
    tocados++;
  }
...
function usarReliquia(id) {
  if (id === 'manzana') {
    ...
    const libres = celdasLibres()
      .filter(c => Math.hypot(c.x - jugador.pos.x, c.z - jugador.pos.z) > 30);
    if (!libres.length) return false;
    const destino = libres[Math.floor(Math.random() * libres.length)];
    jugador.pos.x = destino.x;
    jugador.pos.z = destino.z;
    audio.sonar('cruzar');
    destello('#9fd8ff', 0.55, 380);
    sacudida = 0.9;
    avisar('LOS VIENTOS TE LLEVAN');
  } else if (id === 'ojo') {
    efectos.ojo = 20;
...
function usarConsumible(id) {
  ...
  if (id === 'frasco') {
    ...
    for (const e of enemigos) {
      ...
      if (d < 16) {
        if (e.recibir(110 * jugador.mult.dano * furia(), 'fuego')) marcarBaja();
        tocados++;
      }
    }
    audio.sonar('fuego');
    ...
    setTimeout(() => {
      if (!muerto) lanzarFlecha(1, rumbo, 0, 4, 'lanza');
    }, 230);
    avisar('JABALINA');
  } else if (id === 'vino') {
    relojFuria = 10;
...
function golpeRecibido(dano, absorbido) {
  audio.sonar('dano');
  if (dano <= 0 && absorbido > 0) {
    destello('#4a7fb0', 0.3, 90);
    sacudida = Math.max(sacudida, 0.3);
    return;
  }
...
const CONTROLES = [
  ...
  ['V', 'Recordar donde esta la grieta cuando se abre'],
...
function iconoDe(art, tipo) {
  ...
  else if (art.delSuelo !== undefined) t = recursos.items && recursos.items[art.delSuelo];
...
function panelPersonaje() {
  ...
  abrirPanel(`<h3>PERSONAJE</h3>
    ...
    <h4>ARCOS — el de fontanero ya es tuyo; los demas se ganan jugando</h4>
    <table>${filas}</table>
...
function panelSonido() {
  const fila = (id, nombre, apagado, nota) => `<tr>
      <td class="nom">${nombre}</td>
      <td>${nota}</td>
      <td class="precio"><button class="accion" data-sonido="${id}">${apagado ? 'ENCENDER' : 'APAGAR'}</button></td>
    </tr>`;
  abrirPanel(`<h3>SONIDO</h3>
    <span class="bolsa">LA TECLA <b>M</b> APAGA Y ENCIENDE TODO</span>
    <table>
      ${fila('todo', 'TODO EL SONIDO', audio.silencio, 'Musica y efectos a la vez')}
      ${fila('musica', 'SOLO LA MUSICA', audio.silencioMusica, 'Deja los efectos sonando')}
      ${fila('efectos', 'SOLO LOS EFECTOS', audio.silencioEfectos, 'Deja la musica sonando')}
    </table>`);

  hoja.querySelectorAll('[data-sonido]').forEach(b => {
    b.addEventListener('click', () => {
      const q = b.dataset.sonido;
      if (q === 'todo') audio.mudo();
      else if (q === 'musica') audio.mudoMusica();
      else audio.mudoEfectos();
      if (!audio.silencio && !audio.silencioEfectos) audio.sonar('recoger');
      panelSonido();
    });
  });
}
...
function panelGloria() {
  ...
  const fila = art => {
    const comprado = tieneGloria(art.id);
  ...
  abrirPanel(`<h3>GLORIA</h3>
    <span class="bolsa">${TODO_GRATIS ? 'TODO DESBLOQUEADO · SOLO PONLO Y QUITALO' : 'TE QUEDAN ' + Math.max(0, disponible) + ' DE GLORIA'}</span>
...
function panelComo() {
  ...
  abrirPanel(`<h3>COMO JUGAR</h3><div class="guia">
    ...
    ${seccion('A QUIEN TE ENFRENTAS')}
    <div class="tarjetas">
      ${carta(dib('fichas', 0), 'CICLOPE', 'Va directo a ti y golpea de cerca con el garrote. Lento pero aguanta mucho. Rodealo y no dejes que te acorrale.', 'DE CERCA')}
      ${carta(dib('fichas', 1), 'PRETENDIENTE', 'Se queda lejos y te tira lanzas. Cubrete tras las columnas: sus lanzas se detienen en los muros.', 'DE LEJOS')}
      ${carta(dib('fichas', 2), 'POLIFEMO', 'Aparece en la ronda 15 con catorce veces la vida de un ciclope. Si cae, ganaste la partida.', 'RONDA 15')}
    </div>
    ...
    <div class="tarjetas">
      ${carta(dib('fichas', 3), 'EL MERCADER', 'Entre rondas pulsa E y aparece. Vende armas y reliquias por oro, pero solo te deja llevarte una cosa por ronda.', 'E')}
      ${carta(dib('fichas', 4), 'LA GRIETA', 'Portal morado en el centro del mapa. Se abre al terminar la ronda 3 y la 13. Metete en el para cruzar al Otro Lado.', 'PISALO')}
      ${carta(dib('fichas', 5), 'ORO Y GLORIA', 'El oro se gasta en el mercader y se pierde al morir. La gloria queda para siempre y se gasta antes de empezar.', 'SIEMPRE')}
    </div>
    ...
    Cada 3 rondas se abre un <b>portal morado en el centro del mapa</b> (sale marcado en
    el minimapa). Metete en el para cruzar al Otro Lado: el mismo palacio en rojo,
    enemigos con casi el doble de vida pero <b>triple oro</b>.
    <b>Una vez dentro no puedes salir hasta que pasen 3 rondas</b>: entonces se abre un
    portal azul en el mismo centro y ese te regresa.</div>
    ...
    <div class="nota"><b>MUSICA Y SONIDO</b>
    Musica: <b>Fight Them Until We Can't</b> de <b>Zander Noriega</b> (CC BY 3.0),
    <b>Boss Battle #6</b> y <b>#9</b> de <b>nene</b> (CC0) y
    <b>Cosmic Combatants</b> de <b>Peachtea</b> (CC0).
    Efectos de <b>Kenney.nl</b> (CC0). Pulsa <b>M</b> para silenciar.</div>
  </div>`);
}
...
function gloriaDe(datos) {
  const base = datos.ronda * 12 + datos.bajas * 2;
  const total = datos.gano ? base + 400 : Math.round(base * 0.45);
  return modoActivo('pesadilla') ? total * 3 : total;
}
...
function aplicarModos() {
  for (const o of OBJETOS_GLORIA) {
    if (!modoActivo(o.id)) continue;
    jugador[o.arma === 'portales' ? 'pistola' : o.arma] = true;
    if (o.arma !== 'cazador') jugador.guardar(o.arma, 1, true);
  }
  jugador.sinArco = modoActivo('sinArco');
  jugador.alDisparar = jugador.sinArco ? () => {} : disparar;
  if (jugador.sinArco) {
    jugador.flechas = 0;
    jugador.flechasMax = 0;
    jugador.tension = 0;
    jugador.tensando = false;
    jugador.mano = 'cuchillo';
  }
  if (modoActivo('salto')) { jugador.oro = 300; rondas.numero = 4; }
  jugador.ranuras = modoActivo('ranura') ? 5 : 4;
  director.presion = modoActivo('pesadilla') ? 1.45 : 1;
  if (tienda) {
    tienda.cuantos = modoActivo('oferta5') ? 5 : 4;
    tienda.descuento = modoActivo('descuento') ? 0.85 : 1;
  }
  if (otroLado) {
    if (modoActivo('otroladoFijo')) { if (!otroLado.dentro) otroLado.entrar(); }
    else if (otroLado.dentro) otroLado.salir();
  }
}
...
function reiniciar() {
  ...
  menu.querySelector('p').textContent = esTactil() ? 'TOCA PARA EMPEZAR' : 'CLIC PARA EMPEZAR';
...
lienzo.addEventListener('click', () => {
  audio.arrancar();
  if (muerto) { reiniciar(); return; }
  if (camaraCae >= 0) limpiarDerrumbe();
  if (!partidaEmpezada) { partidaEmpezada = true; aplicarModos(); }
}, true);

addEventListener('keydown', e => {
  if (e.code === 'KeyM') avisar(audio.mudo() ? 'SILENCIO' : 'SONIDO');
  if (e.code === 'KeyV' && jugador && jugador.activo) {
    avisar(grieta && grieta.abierta
      ? 'LA GRIETA ESTA EN EL CENTRO DEL MAPA'
      : 'LA GRIETA ESTA CERRADA');
  }
});
    ...
    if (!fuera) {
      for (const e of enemigos) {
        ...
        if (dx * dx + dz * dz < 3.2 && dy > 0 && dy < 7) {
          audio.sonar('carne', e.pos);
          if (e.recibir(f.dano, f.marca)) marcarBaja();
...
const elDescanso = document.getElementById('descanso');
function pintarDescanso() {
  const enPausa = rondas && rondas.estado === 'descanso' && jugador && jugador.activo;
  elDescanso.classList.toggle('ver', !!enPausa);
  if (!enPausa) return;
  if (tienda.abierta) { elDescanso.innerHTML = 'EL RELOJ SE DETIENE MIENTRAS COMERCIAS'; return; }
  const seg = Math.ceil(rondas.restante);
...
function pintarHud() {
  ...
  pintarAgonia(salud);
  const hojaCara = carasDelArco();
  if (hojaCara.length === 5) {
    const cara = salud > 0.8 ? 0 : salud > 0.6 ? 1 : salud > 0.4 ? 2 : salud > 0.2 ? 3 : 4;
    const marca = cara + (arcoPuesto() || '');
    if (elCara.dataset.cara !== marca) {
      elCara.dataset.cara = marca;
      elCara.style.backgroundImage = `url(${hojaCara[cara]})`;
    }
  } else {
  ...
  if (picoReloj > 0 && imagenesPico.length) {
    ...
    clave = 'vacia';
    url = imagenManoVacia;
  } else if (cuchilloReloj > 0 && cuchilloCuadro === 1 && imagenesKTajo.length) {
    const paso = Math.min(0.999, (0.3 - cuchilloReloj) / 0.3);
    const c = Math.floor(paso * 3);
    clave = 'kt' + c;
    url = imagenesKTajo[c];
  ...
  } else if (jugador.sinArco && imagenesCuchillo.length) {
    clave = 'k0';
    url = imagenesCuchillo[0];
  } else {
  ...
  const esc = escalaArco();
  if (arma.dataset.escala !== String(esc)) {
    arma.dataset.escala = String(esc);
    arma.style.backgroundSize = `auto ${(96 * esc).toFixed(1)}vh`;
  }
}
...
function paso(dt) {
  if (jugador.activo) {
    ...
    for (const e of enemigos) {
      ...
      if (!e.vivo && !e.saqueado) {
        e.saqueado = true;
        if (Math.random() < (jugador.vida < jugador.vidaMax * 0.5 ? 0.1 : 0.03)) {
          soltarUno(6, e.malla.position);
        }
      }
      e.verFantasma(efectos.ojo > 0);
    }
  ...
  pintarHud();
  if (minimapa) {
    minimapa.dibujar(dt, jugador, enemigos, objetos, grieta && grieta.abierta ? grieta : null, portales);
...
cargarArte().then(() => {
  ...
  if (esTelefono()) {
    document.body.classList.add('telefono');
    document.getElementById('entrarIgual').addEventListener('click', () => {
      document.body.classList.remove('telefono');
    });
  }
  ...
  if (esTactil()) {
    new Tactil(jugador, {
      empezar: () => {
        ...
        if (!partidaEmpezada) { partidaEmpezada = true; aplicarModos(); }
        jugador.libre = true;
        jugador._activar(true);
      },
      lanzar: () => jugador.alLanzarHacha && jugador.alLanzarHacha(),
      cambiar: () => {
        if (!jugador.hacha) { avisar('NO TIENES HACHA'); return; }
        jugador.mano = jugador.mano === 'hacha' ? 'cuchillo' : 'hacha';
        if (jugador.alCambiar) jugador.alCambiar(jugador.mano);
      },
      tienda: () => jugador.alComerciar && jugador.alComerciar(),
      grieta: () => {
        avisar(grieta && grieta.abierta
          ? 'LA GRIETA ESTA EN EL CENTRO DEL MAPA'
          : 'LA GRIETA ESTA CERRADA');
